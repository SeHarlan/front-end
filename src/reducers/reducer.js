...
export default function reducer(state = initialState, { type, payload }) {
  switch(type) {
    ...
    case RESET_COVID_DATA:
      return { ...state, covidChartData: {} };
    default: 
      return state;
  }
}
